    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="lg"
                ...
                {activeTab === 0 && (
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            <TextField label="Mã hàng hóa"
                                       helperText="Mã hàng tự động" disabled/>
                            ...
                            <Select fullWidth displayEmpty defaultValue="">
                                ...
                                <MenuItem value="Lựa chọn">--Lựa
                                    chọn--</MenuItem>
                            </Select>
                            <TextField label="Vị trí"/>
                            <TextField label="Giá vốn" type="number"
                                       defaultValue={0}/>
                            <TextField
                                label="Giá bán"
                                type="number"
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{
                                ...
                                <Typography variant="body1" fontWeight="bold">Quản
                                    lý tồn kho</Typography>
                            ...
                            {manageStock && (
                                <Box sx={{
                                    ...
                                    <TextField label="Nhiều nhất" type="number"
                        ...
                        <Accordion sx={{
                            ...
                            <AccordionSummary expandIcon={<ExpandMoreIcon/>}>
                                <Typography variant="body1" fontWeight="bold">Đơn
                                    vị tính</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <TextField label="Đơn vị cơ bản" fullWidth/>
                                <Button startIcon={<AddIcon/>} sx={{mt: 1}}>Thêm
                                    đơn vị</Button>
                            </AccordionDetails>
                        </Accordion>
                    </Box>
            ...
            <DialogActions sx={{padding: 2, justifyContent: 'space-between'}}>
                <Button variant="outlined" onClick={onClose} color="primary">Bỏ
                    qua</Button>
                <Box sx={{display: 'flex', gap: 2}}>
                    <Button variant="contained" color="primary" onClick={onSave}
                            startIcon={<SaveIcon/>}>Lưu</Button>
                    <Button variant="contained" color="success"
                            onClick={onSaveAndAddNew} startIcon={<SaveIcon/>}>
                        Lưu & Thêm mới
                    </Button>
                </Box>
            </DialogActions>
