...
const tableRows = [
    ...
    { id: 'NCC0005', name: 'Cửa hàng Đại Việt', phone: '0909123456', totalPurchase: '81,845,500' },
    { id: 'NCC0004', name: 'Đại lý Hồng Phúc', phone: '0909234567', totalPurchase: '29,989,500' },
    // Additional rows
];
const SuppliersPage = () => {
                        ...
                        <CustomTable
                            ...
                            renderCollapse={(row) => (
                                <ProductDetailsCollapse
                                    ...
                                    details={[
                                        { label: "Mã nhà cung cấp", value: row.id },
                                        { label: "Tên nhà cung cấp", value: row.name },
                                        { label: "Điện thoại", value: row.phone },
                                        { label: "Email", value: row.email },
                                        { label: "Nợ cần trả hiện tại", value: row.debt },
                                        { label: "Tổng mua", value: row.totalPurchase, sx: { fontWeight: 'bold', color: 'green' } },
                                    ]}
                                />
                            )}
                        />
